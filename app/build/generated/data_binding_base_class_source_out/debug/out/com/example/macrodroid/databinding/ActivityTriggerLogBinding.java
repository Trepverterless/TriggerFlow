...
public final class ActivityTriggerLogBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityTriggerLogBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTriggerLogBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_trigger_log, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTriggerLogBinding bind(@NonNull View rootView) {
